...
/**
 * 오버레이 애니메이션 — GPU 가속, backdrop-blur 제거로 렌더 최적화
 */
...
/**
 * 모달 본체 애니메이션 — transform만 사용하여 GPU 가속 레이어 활용
 */
const modalVariants = {
 ...
 *
 * 주의: 상위 컴포넌트에서 모달을 열 때마다 key를 변경하여 리마운트해야 초기값이 정상 반영됩니다.
 */
        ...
        <AnimatePresence>
            {isOpen && (
                <div className="fixed inset-0 z-5000 flex items-center justify-center p-4">
                    {/* 오버레이 — backdrop-blur 제거, will-change로 GPU 가속 */}
                    <motion.div
